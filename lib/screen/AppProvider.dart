...
class ClassRoomProvider extends ChangeNotifier {
  ...
  Future updateClassRoom(SubjectsModel subjectsModel, classRoomId) async {
    String url = "https://hamon-interviewapi.herokuapp.com/classrooms/" +
        classRoomId.toString() +
        "?api_key=126a5";
    var map = new Map<String, dynamic>();
    map['subject'] = subjectsModel.id.toString();
    ...
    if (response.statusCode == 200) {
      ...
      if (null != selectedClassRoomModelList &&
          selectedClassRoomModelList.length > 0) {
        ...
        if (index > -1) {
          selectedClassRoomModelList[index].subject =
              int.parse(jsonData['subject'].toString());
          selectedClassRoomModelList[index].id =
              int.parse(jsonData['id'].toString());
          selectedClassRoomModelList[index].name =
              (jsonData['name'].toString());
          selectedClassRoomModelList[index].layout =
              (jsonData['layout'].toString());
          selectedClassRoomModelList[index].size =
              int.parse(jsonData['size'].toString());
          selectedClassRoomModelList[index].subjectName = subjectsModel.name;
          selectedClassRoomModelList[index].teacher = subjectsModel.teacher;
          selectedClassRoomModelList[index].credits = subjectsModel.credits;
          ...
          classRoomModel.subjectName = subjectsModel.name;
          classRoomModel.teacher = subjectsModel.teacher;
          classRoomModel.credits = subjectsModel.credits;
